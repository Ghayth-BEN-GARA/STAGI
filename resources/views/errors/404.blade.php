				...
				<div class = "container">				
					<div class = "row d-flex align-items-center justify-content-center">
						<div class = "about-content col-lg-12">
							...
							<p class = "text-white link-nav"><a href = "{{url('/')}}">Accueil</a><span class = "lnr lnr-arrow-right"></span><a href = "{{url('/page-not-found')}}"> Page introuvable</a></p>
						</div>	
					</div>
				</div>
			</section>
                    ...
                    <div class = "row">
                        <div class = "col-lg-12 col-md-12">
                            ...
                            <div class = "message-box">
                                ...
                                <p>La page que vous recherchez est peut-être supprimée ou elle est temporairement indisponible.</p>
